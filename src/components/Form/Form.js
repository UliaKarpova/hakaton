    ...
    return (
        <form className='main-form'>
            ...
            <div className='main-form__radio-block block'>
                ...
                <p className='main-form__text'>{pickOut ? 'Выделение области на карте' : 'Перемещение выделенной области'}</p>
                    <label htmlFor='rectangle' className='main-form__label'>
                        <input type='radio' className='main-form__radio-input' name='choice' id='rectangle' onChange={onChange} checked={pickOut} value='rectangle' />

                        <div className='main-form__radio rectangle'/>
                    </label>

                    <label htmlFor='hand' className='main-form__label'>
                        <input type='radio' className='main-form__radio-input' name='choice' id='hand' value='hand' onChange={onChange} checked={!pickOut} />
            ...
            <div className='block'>
                ...
                <input type='range' className='main-form__range' onChange={rangeOnChange} step='5'/>
